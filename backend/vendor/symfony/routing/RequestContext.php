...
class RequestContext
{
    ...
    public function __construct(string $baseUrl = '', string $method = 'GET', string $host = 'localhost', string $scheme = 'http', int $httpPort = 80, int $httpsPort = 8090, string $path = '/', string $queryString = '')
    {
    ...
    public static function fromUri(string $uri, string $host = 'localhost', string $scheme = 'http', int $httpPort = 80, int $httpsPort = 8090): self
    {
        $uri = parse_url($uri);
